...
public class PdfService {
    ...
    private void drawTableRow(PDPageContentStream contentStream, float margin, float tableWidth, float rowHeight, float yPosition, UserDto user) throws IOException {
